...
WebUI.click(findTestObject('4- Response Moderation/Tags input field'))

WebUI.setText(findTestObject('4- Response Moderation/Tags input field'), 'Adding Tags')

WebUI.sendKeys(findTestObject('4- Response Moderation/Tags input field'), Keys.chord(Keys.ENTER))
...
WebUI.verifyTextPresent('#AddingTags', false)
