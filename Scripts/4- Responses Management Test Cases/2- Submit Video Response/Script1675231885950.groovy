...
//WebUI.navigateToUrl(('http://dev.ccapps.fankave.com/cisco/feedback/' + 'automatedtestcampaign02') + randomnumber)
...
WebUI.setText(findTestObject('Object Repository/Campaign management/SubmitResponse/input_Get in Touch_name'), 'Waqas')

WebUI.click(findTestObject('Object Repository/Campaign management/SubmitResponse/button_Submit'))
