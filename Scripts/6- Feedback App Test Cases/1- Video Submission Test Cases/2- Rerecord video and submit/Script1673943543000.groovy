...
while (button == true) {
    ...
    if (rerecord == 1) {
        WebUI.click(findTestObject('7- Feedback App/Video Recording Objects/button_Rerecord'))

        WebUI.click(findTestObject('7- Feedback App/Video Recording Objects/Rerecord Yes Button'))
