...
WebUI.delay(2)
	...
	WebUI.delay(4)
	WebUI.click(findTestObject('7- Feedback App/Video Recording Objects/Home icon on Recording screen'))
	

WebUI.verifyElementPresent(findTestObject('7- Feedback App/Video Recording Objects/Home Screen Heading'), 3)
