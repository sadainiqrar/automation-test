...
WebUI.click(findTestObject('Object Repository/2- Campaign Management/li_Archived'))
...
WebUI.click(findTestObject('2- Campaign Management/div_Unarchive Campaign'))

WebUI.verifyTextPresent('Campaign unarchived', false)
